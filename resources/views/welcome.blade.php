...
<div class="container">
    <div class="left-part">
        @if ($successMessage ?? '')
            <div style="padding: 10px; border-radius: 8px; background-color: #769656;
            margin-top: 16px; color: #fff; transition: transform 0.3s ease-in-out; cursor: pointer; border: none;" >
                {{$successMessage ?? ''}}
            </div>
        @endif
